...
if __name__ == "__main__":
    print("Starting textbook content population to Qdrant...")
    print("This will index all textbook content into the vector database.")
    print("")
    
    success = populate_qdrant()
    
    if success:
        print("\n🎉 SUCCESS: Textbook content has been populated to Qdrant!")
        print("The Qwen agent should now be able to retrieve textbook content properly.")
        print("\nYou can now run the test script to verify the RAG pipeline:")
        print("python test_rag_pipeline_fixed.py")
    else:
        print("\n❌ FAILED: Could not populate Qdrant with textbook content.")
        print("Please check the error messages above and ensure:")
        print("1. Your Qdrant credentials are correct in the .env file")
        print("2. Your Qdrant cluster is accessible from your network")
        print("3. The embedding service is properly configured")