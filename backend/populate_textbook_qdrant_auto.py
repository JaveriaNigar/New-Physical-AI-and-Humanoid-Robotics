...
Automated version that doesn't require user input.
"""
import os
import sys
import uuid
...
if __name__ == "__main__":
    print("Automatically running Qdrant population without user confirmation...")
    print("Ensuring .env file has been updated with real Qdrant credentials...")
    print("Textbook content is available in the docs directory...")
    print("")
